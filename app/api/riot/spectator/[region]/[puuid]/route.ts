/**
 * Riot Spectator API - Get active game by PUUID
 */
...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      const url = `https://${regionHost}/lol/spectator/v5/active-games/by-summoner/${encodeURIComponent(puuid)}`;
      ...
      // If 404, it means the summoner is not in an active game
    ...
    console.error('Spectator info error:', error.message);
    return Response.json({ 
      error: 'Failed to get active game info', 
